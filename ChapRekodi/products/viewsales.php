...
<head>
    ...
    <style>
        ...
        .navbar{
            ...
            margin-bottom:30px;
            border-bottom: 2px solid rgba(121, 121, 201, 0.445);
        }
...
<body>
    ...
    <div class="navbar">
        <div class="logo">
            <h1><a href="index.php" style="text-decoration:none;color:rgba(121, 121, 201, 0.445)">ChapRekodi</a></h1>
        </div>
        <div class="navlinks">
            <ul>
    ...
    <h1 style="text-align:center" class="heading">Angalia Mauzo na Mapato</h1>
    <p style="text-align:center;" class="paragraph">Karibu katika sehemu ambapo mauzo na mapato yanarekodiwa, kuwa huru kuangalia mauzo yaliyofanyika</p>

<?php
    include_once "connection.php";

    $query = "SELECT * FROM mauzo";
    $result = mysqli_query($connection, $query);
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        <tr>
            <th>id</th>
            <th>Namba ya Kuku au Sababu</th>
            <th>Bei ya kila kuku</th>
            <th>Jumla ya bei</th>
            <th>Tarehe</th>
            <th>Vitendo</th>
        </tr>';
        ...
        echo ' 
                <tr>
                        ...
                        <td>'.$row['beiyakilakuku'].'</td>
                        <td>'.$row['jumlayabei'].'</td>
                        <td>'.$row['tarehe'].'</td>
                        <td>
                            <a href="update.php?id='.$row['id'].'" class="delete">Badili</a>
                            <a href="deletesales.php?id='.$row['id'].' " class="delete" style="background-color:red;">Futa</a>
                        </td>
                </tr>';
        }
        ...
        while($row2 = mysqli_fetch_assoc($result2)){
            echo "<p><b>Tsh ".$row2["SUM(jumlayabei)"]."/=</b></p>";
            } echo '</td>
            <td></td>
            <td></td>
            </tr>
        ...
        echo "<p style='text-align:center;margin-top:20%;font-size:24px;color:rgba(121, 121, 201, 0.445);'>Hakuna mapato kwa sasa!</p>";
    }
